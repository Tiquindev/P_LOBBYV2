...
public class UtilAlg {
	  ...
	  {
	    return (HasSight(paramLocation, paramPlayer.getLocation())) || (HasSight(paramLocation, paramPlayer.getEyeLocation()));
	  }
	  
	  public static boolean HasSight(Location paramLocation1, Location paramLocation2)
	  {
	    Location localLocation = new Location(paramLocation1.getWorld(), paramLocation1.getX(), paramLocation1.getY(), paramLocation1.getZ());
	    ...
	    while (UtilMath.offset(localLocation, paramLocation2) > d)
	    {
	      ...
	      if (!Main.getUtilBlock().airFoliage(localLocation.getBlock())) {
	        return false;
	      }
	    }
	    return true;
