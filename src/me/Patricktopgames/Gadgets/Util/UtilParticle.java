	      ...
	      else
	      {
	        ...
	        else
	        {
	          ...
	          packetConstructor = packetClass.getDeclaredConstructor(new Class[] { enumParticle, Boolean.TYPE, Float.TYPE, 
	            Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE, Integer.TYPE, 
	            int[].class });
	        }
	      }
	    }
